...
static constexpr ::PROTOBUF_NAMESPACE_ID::Metadata* file_level_metadata_event_2eproto = nullptr;
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_event_2eproto::offsets[1] = {};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_event_2eproto = {
  false, false, descriptor_table_protodef_event_2eproto, "event.proto", 13,
  &descriptor_table_event_2eproto_once, descriptor_table_event_2eproto_sccs, descriptor_table_event_2eproto_deps, 0, 0,
  schemas, file_default_instances, TableStruct_event_2eproto::offsets,
  file_level_metadata_event_2eproto, 0, file_level_enum_descriptors_event_2eproto, file_level_service_descriptors_event_2eproto,
};
